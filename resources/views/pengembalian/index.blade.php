    ...
    <div class="card">
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col">
                    <h5 class="mb-0">Daftar Pengembalian & Keterlambatan</h5>
                </div>
                <div class="col-auto">
                                    ...
                                    <td>
                                        @if($peminjaman->dendaRecord)
                                            <span class="text-danger fw-bold">
                                                Rp {{ number_format($peminjaman->dendaRecord->total_denda, 0, ',', '.') }}
                                            </span>
                                            <br>
                                            <small class="badge bg-{{ $peminjaman->dendaRecord->status_bayar == 'belum-dibayar' ? 'danger' : 'success' }}">
                                                {{ $peminjaman->dendaRecord->status_bayar == 'belum-dibayar' ? 'Belum Lunas' : 'Lunas' }}
                                            </small>
                                        @else
